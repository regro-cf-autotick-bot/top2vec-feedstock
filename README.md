...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/top2vec-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15468&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/top2vec-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `top2vec` can be installed with:

```
conda install top2vec
```

It is possible to list all of the versions of `top2vec` available on your platform with:
